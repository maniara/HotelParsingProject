...
public class AgodaParser {
	public ArrayList<RoomPrice> getRooms(String hotelName, String checkInDate, String checkOutDate) throws MalformedURLException,IOException{
		
		ArrayList<RoomPrice> roomPriceList = new ArrayList<RoomPrice>();
		
		hotelName = "nine-tree-hotel-myeong-dong";
		...
		for(Element e1 : source.getAllElements())
		{
			...
			if(e1.getAttributeValue("data-selenium").equals("room-item"))
			{
				...
				roomPriceList.add(new RoomPrice(checkInDate,roomType,price));
			}
		}
