...
public class AgodaParser {
	public static ArrayList<RoomPrice> getRooms(String hotelName, String checkInDate, String checkOutDate)
		...
		while (success == false) {
			//Source source = new Source(AgodaRequester.sendPost(hotelName, checkInDate, checkOutDate));
			Source source = new Source(new URL(url));
			
			//System.out.println(source.getFirstElementByClass("currency anchor").getContent().toString());
			//check the currency
